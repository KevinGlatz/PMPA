...
\begin{itemize}
	...
	\begin{itemize}
		\item Funktional
		App, Quests hinzufügen, Login für User \\
	...
	\begin{itemize}
		\item Funktional
		Datenauslesung wie viele Quest erledigt wurden.\\
		\item Nicht-funktional
		Benutzerfreundlich \\
	\end{itemize}
\end{itemize}
...
Vorhanden in der Datei ProjektplanGEOQuest\\
\subsection{Meilensteine}
\includegraphics[width=1\linewidth]{Meilensteinplan}\\
\subsection{Gant-Chart}
Vorhanden in der Datei ProjektplanGEOQuest\\
\subsection{Abnahmekriterien}
Funktionierende App, Datenbank, Wartbarkeit, Webserver\\
\subsection{Pläne zur Evaluierung}
Funktionalität, Bedienbarkeit, Wartung\\
\subsection{Ergänzungen und zu klärende Punkte}
Login zum Adminbereich, Webserver, etc, \\
